...
<span class="profile-status-container" data-pioneer="<?= $isPioneer ? '1' : '0' ?>">
<?php if ($isPioneer): ?>
...
<div class="bioItem"><span class="bioIcon" style="background:#f0f0f0;color:#3b5dd3;"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2c-3.3 0-6 2.7-6 6 0 5 6 12 6 12s6-7 6-12c0-3.3-2.7-6-6-6z"/><circle cx="12" cy="8" r="2"/></svg></span><span class="bioLabel">Город:</span><span class="bioValue"><?= esc($profileUser['city'] ?? '') ?></span></div>
<div class="bioItem"><span class="bioIcon" style="background:#f0f0f0;color:#3b5dd3;"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg></span><span class="bioLabel">Статус отношений:</span><span class="bioValue"><?= esc($profileUser['relationship'] ?? '') ?></span></div>
<div class="bioItem"><span class="bioIcon" style="background:#f0f0f0;color:#3b5dd3;"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg></span><span class="bioLabel">Интересы:</span><span class="bioValue"><?= esc($profileUser['interests'] ?? '') ?></span></div>
...
<?php if (!$showPosts): ?>
<div class="no-posts-placeholder" style="text-align:center;padding:40px 20px;"><p style="color:#8b8fa3;">Публикации ограничены</p></div>
...
function toggleBio() {
    const wrapper = document.getElementById('bio-wrapper');
...
async function updateStatus() {
    try {
        const data = await kop.get(`/api/users/${profileUserId}/status?_=${Date.now()}`);
        const textSpan = document.getElementById('profile-status-text');
        if (textSpan && data && data.text && data.class) {
