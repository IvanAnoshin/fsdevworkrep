...
// Обновляем last_active при каждом заходе на профиль
...
<body>
    ...
    <div class="mainArea">
        <div class="profileContainer">
            ...
            <div class="profileNavigation">
                <button class="profileNavigation__btn profileNavigation__btn--active">Публикации</button>
    ...
    <script>
        ...
        async function openCommentsModal(postId) {
            ...
            // Находим оригинальный пост и извлекаем только его тело
            ...
            // Обработчик отправки комментария (назначается при каждом открытии)
            ...
            // Открываем модальное окно и запрещаем скролл фона
            modal.style.display = 'flex';
            document.body.classList.add('no-scroll');
        }

        // Закрытие модалки (крестик и оверлей)
        ...
        kop.on('.profileNavigation__btn', 'click', function(e) {
            ...
            kop.hide('.post, .facebookSection, .personalInfoSection');
            if (act === 'facebook') {
                kop.hide('.post');
                kop.hide('.personalInfoSection');
                kop.show('.facebookSection');
            } else if (act === 'personal') {
                kop.hide('.post');
                kop.hide('.facebookSection');
                kop.show('.personalInfoSection');
            } else {
                kop.hide('.facebookSection');
                kop.hide('.personalInfoSection');
                kop.show('.post');
